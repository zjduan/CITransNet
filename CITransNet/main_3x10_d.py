...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='../data_multi/10t10t_3x10/')
    ...
    parser.add_argument('--n_bidder', type=int, default=3)
    ...
    parser.add_argument('--lamb_update_freq', type=int, default=4)
